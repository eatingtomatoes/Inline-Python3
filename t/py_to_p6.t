...
is $main.run('[1, 2]', :eval), [1, 2];
is $main.run('[1, [2, 3]]', :eval), [1, [2, 3]];
is $main.run('{u"a": 1, u"b": 2}', :eval), {a => 1, b => 2};
is $main.run('{u"a": 1, u"b": {u"c": 3}}', :eval), {a => 1, b => {c => 3}};
is $main.run('[1, {u"b": {u"c": 3}}]', :eval), [1, {b => {c => 3}}];
